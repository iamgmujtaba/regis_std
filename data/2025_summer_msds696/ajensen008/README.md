# Amber Jensen - MSDS 696 Portfolio
...
├── reports/
│   └── ajensen008_practicumii_report.pdf
├── presentations/
│   └── ajensen008_practicumii_slides.pdf
└── assets/
    └── (additional files)
```
...
### Project Report  
- **File name:** `ajensen008_practicumii_report.pdf`
- **Location:** `reports/` folder
- **Format:** PDF only

### Presentation Slides
- **File name:** `ajensen008_practicumii_slides.pdf`  
