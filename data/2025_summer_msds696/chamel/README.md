# Chandon Hamel - MSDS 696 Portfolio
...
├── reports/
│   └── chamel_practicumii_report.pdf
├── presentations/
│   └── chamel_practicumii_slides.pdf
└── assets/
    └── (additional files)
```
...
### Project Report  
- **File name:** `chamel_practicumii_report.pdf`
- **Location:** `reports/` folder
- **Format:** PDF only

### Presentation Slides
- **File name:** `chamel_practicumii_slides.pdf`  
