# Matthew Scardino - MSDS 696 Portfolio
...
├── reports/
│   └── scard659_practicumii_report.pdf
├── presentations/
│   └── scard659_practicumii_slides.pdf
└── assets/
    └── (additional files)
```
...
### Project Report  
- **File name:** `scard659_practicumii_report.pdf`
- **Location:** `reports/` folder
- **Format:** PDF only

### Presentation Slides
- **File name:** `scard659_practicumii_slides.pdf`  
