# Abhilash Reddy Pochampally - MSDS 696 Portfolio
...
├── reports/
│   └── apochampally_practicumii_report.pdf
├── presentations/
│   └── apochampally_practicumii_slides.pdf
└── assets/
    └── (additional files)
```
...
### Project Report  
- **File name:** `apochampally_practicumii_report.pdf`
- **Location:** `reports/` folder
- **Format:** PDF only

### Presentation Slides
- **File name:** `apochampally_practicumii_slides.pdf`  
...
---
*Generated on 2025-11-08 20:48:41*
