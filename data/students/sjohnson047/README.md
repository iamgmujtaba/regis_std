# Reed Johnson - Data Science Portfolio
...
├── reports/
│   ├── sjohnson047_practicum1_report.pdf  # MSDS 692 report
│   └── sjohnson047_practicum2_report.pdf  # MSDS 696 report
├── presentations/
│   ├── sjohnson047_practicum1_slides.pdf  # MSDS 692 slides
│   └── sjohnson047_practicum2_slides.pdf  # MSDS 696 slides
└── assets/
    └── (additional files)
```
...
### 📄 CV/Resume
- **Current file:** `sjohnson047_cv.pdf` ⚠️ **REPLACE THIS**
- **Format:** PDF only
- **Note:** This is an example file - replace with your actual CV

### 📊 Practicum I Files (MSDS 692)
- **Report:** `reports/sjohnson047_practicum1_report.pdf` ⚠️ **REPLACE THIS**
- **Slides:** `presentations/sjohnson047_practicum1_slides.pdf` ⚠️ **REPLACE THIS**
- **Format:** PDF only
- **Note:** These are example files - replace with your actual project files

### 📊 Practicum II Files (MSDS 696)
- **Report:** `reports/sjohnson047_practicum2_report.pdf` ⚠️ **REPLACE THIS**
- **Slides:** `presentations/sjohnson047_practicum2_slides.pdf` ⚠️ **REPLACE THIS**
- **Format:** PDF only
- **Note:** These are example files - replace with your actual project files
