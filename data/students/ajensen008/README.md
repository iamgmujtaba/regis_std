...
- **File name:** `ajensen008_practicum1_report.pdf`
- **Location:** `reports/` folder
- **Format:** PDF only

### Practicum I Slides (MSDS 692)
- **File name:** `ajensen008_practicum1_slides.pdf`  
- **Location:** `presentations/` folder
- **Format:** PDF only

### Practicum II Report (MSDS 696)
- **File name:** `ajensen008_practicum2_report.pdf`
- **Location:** `reports/` folder
- **Format:** PDF only

### Practicum II Slides (MSDS 696)
- **File name:** `ajensen008_practicum2_slides.pdf`  
- **Location:** `presentations/` folder
- **Format:** PDF only
