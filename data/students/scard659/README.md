...
### 📄 CV/Resume
- **Current file:** `scard659_cv.pdf` ⚠️ **REPLACE THIS**
- **Format:** PDF only
- **Note:** This is an example file - replace with your actual CV

### 📊 Practicum I Files (MSDS 692)
- **Report:** `reports/scard659_practicum1_report.pdf` ⚠️ **REPLACE THIS**
- **Slides:** `presentations/scard659_practicum1_slides.pdf` ⚠️ **REPLACE THIS**
- **Format:** PDF only
- **Note:** These are example files - replace with your actual project files

### 📊 Practicum II Files (MSDS 696)
- **Report:** `reports/scard659_practicum2_report.pdf` ⚠️ **REPLACE THIS**
- **Slides:** `presentations/scard659_practicum2_slides.pdf` ⚠️ **REPLACE THIS**
- **Format:** PDF only
- **Note:** These are example files - replace with your actual project files
