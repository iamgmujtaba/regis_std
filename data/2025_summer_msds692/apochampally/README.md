# Abhilash Reddy Pochampally - MSDS 692 Portfolio
...
├── reports/
│   └── apochampally_practicumi_report.pdf
├── presentations/
│   └── apochampally_practicumi_slides.pdf
└── assets/
    └── (additional files)
```
...
### Project Report  
- **File name:** `apochampally_practicumi_report.pdf`
- **Location:** `reports/` folder
- **Format:** PDF only

### Presentation Slides
- **File name:** `apochampally_practicumi_slides.pdf`  
...
---
*Generated on 2025-11-08 20:48:02*
