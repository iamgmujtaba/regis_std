# Amber Jensen - MSDS 692 Portfolio
...
├── reports/
│   └── ajensen008_practicumi_report.pdf
├── presentations/
│   └── ajensen008_practicumi_slides.pdf
└── assets/
    └── (additional files)
```
...
### Project Report  
- **File name:** `ajensen008_practicumi_report.pdf`
- **Location:** `reports/` folder
- **Format:** PDF only

### Presentation Slides
- **File name:** `ajensen008_practicumi_slides.pdf`  
