# Reed Johnson - MSDS 692 Portfolio
...
├── reports/
│   └── sjohnson047_practicumi_report.pdf
├── presentations/
│   └── sjohnson047_practicumi_slides.pdf
└── assets/
    └── (additional files)
```
...
### Project Report  
- **File name:** `sjohnson047_practicumi_report.pdf`
- **Location:** `reports/` folder
- **Format:** PDF only

### Presentation Slides
- **File name:** `sjohnson047_practicumi_slides.pdf`  
