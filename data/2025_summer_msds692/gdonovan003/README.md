# Grace Donovan - MSDS 692 Portfolio
...
├── reports/
│   └── gdonovan003_practicumi_report.pdf
├── presentations/
│   └── gdonovan003_practicumi_slides.pdf
└── assets/
    └── (additional files)
```
...
### Project Report  
- **File name:** `gdonovan003_practicumi_report.pdf`
- **Location:** `reports/` folder
- **Format:** PDF only

### Presentation Slides
- **File name:** `gdonovan003_practicumi_slides.pdf`  
