# Etana Disasa - MSDS 692 Portfolio
...
├── reports/
│   └── edisasa_practicumi_report.pdf
├── presentations/
│   └── edisasa_practicumi_slides.pdf
└── assets/
    └── (additional files)
```
...
### Project Report  
- **File name:** `edisasa_practicumi_report.pdf`
- **Location:** `reports/` folder
- **Format:** PDF only

### Presentation Slides
- **File name:** `edisasa_practicumi_slides.pdf`  
