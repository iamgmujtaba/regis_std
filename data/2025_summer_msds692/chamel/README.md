# Chandon Hamel - MSDS 692 Portfolio
...
├── reports/
│   └── chamel_practicumi_report.pdf
├── presentations/
│   └── chamel_practicumi_slides.pdf
└── assets/
    └── (additional files)
```
...
### Project Report  
- **File name:** `chamel_practicumi_report.pdf`
- **Location:** `reports/` folder
- **Format:** PDF only

### Presentation Slides
- **File name:** `chamel_practicumi_slides.pdf`  
