# Matthew Scardino - MSDS 692 Portfolio
...
├── reports/
│   └── scard659_practicumi_report.pdf
├── presentations/
│   └── scard659_practicumi_slides.pdf
└── assets/
    └── (additional files)
```
...
### Project Report  
- **File name:** `scard659_practicumi_report.pdf`
- **Location:** `reports/` folder
- **Format:** PDF only

### Presentation Slides
- **File name:** `scard659_practicumi_slides.pdf`  
